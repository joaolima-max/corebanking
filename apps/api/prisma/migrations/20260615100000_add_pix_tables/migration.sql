...
-- AddForeignKey
ALTER TABLE "pix_transfers" ADD CONSTRAINT "pix_transfers_receiver_account_id_fkey" FOREIGN KEY ("receiver_account_id") REFERENCES "accounts"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
